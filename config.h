...
static const char *fonts[]          = { "xos4 Terminus:size=10", "JoyPixels:pixelsize=10:antialias=true:autohint=true"  };
...
static Key keys[] = {
	...
	{ MODKEY,			XK_n,		spawn,		SHCMD("st -e vim -c VimwikiIndex") },
